    ...
    <div className="about flex flex-col sm:flex-row mb-10 lg:mb-20">
      ...
      <div className="texts-wrapper sm:ml-12">
        ...
        <div className="paragraphs lg:text-xl font-light">
          <p>
            Hi there! I am a Software Engineer with 7+ years experience,
            crafting top-notch web solutions for notable organizations like MIT
            and Doctors Without Borders. I excel in PHP, JavaScript, TypeScript,
            API integration, containers, automated tests, databases, server
            admin, SEO, CI...
          </p>
        </div>
